...
include('config.php');
 ...
 $sql = "SELECT * FROM usercomplaint WHERE fullname ='$fullname'";
                    ...
                    //$usertype = $row['role']; //role kepada current user
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="col-lg col-md">
                ...
                <?php if (isset($_GET['success'])) { ?>  <br>   
                    ...
                    <div class="card-header card-header-text">
                        ...
                        <h4 class="card-title">Submitted Complaints by <?php echo$row['name']; ?>
                    &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;

                   
                    
                    <a class="btn btn-outline-primary" href="makecomplaint1.php"><i class="fa-solid fa-square-plus me-2"></i>Make a complaint </a>
