...
<html>
  ...
  <link rel="stylesheet" href="main.css">
    ...
    <i class="fa fa-reorder" onclick="callsh()" style="cursor:pointer;font-size:24px;margin:10px 2px 0px 20px;color:white"></i>		
		<div class="nav-item item1" style="margin-left:5%">
			...
			<a class="btn btn-danger" title="Click to Logout" href="login.php">LOGOUT</a>
		</div>
		</nav>
  ...
  <ul class="navbar-nav" style="width:100%;background-color:#17a2b86e;">
			  <li class="nav-item" >			
		<img src="airasiabulatkau.jpg" width="90px" height="80px">
		   </li>
    <li class="nav-item"  >
	...
	if($num==0)
	{
		...
		©dibikinfazly:
    <a href="https://instagram.com/fazly.jmldn_?utm_medium=copy_link"> Instagram</a>
		</div>
