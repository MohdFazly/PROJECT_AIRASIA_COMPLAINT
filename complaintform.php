                ...
                <div class="card" style="min-height: 485px">
                    ...
                    <div class="card-content table-responsive p-2">
                        <form method="POST" action="complaintprocess.php" enctype="multipart/form-data" class="row g-3">
                          ...
                          <h5 class="form-label">Complain Details</h5>
                            <div class="col-md-12">
                            ...
                            <h5 class="form-label">Location Details</h5>
                            <div class="col-md-6">
                                <label for="flocation" class="form-label">Location Details</label>
                                <input type="text" class="form-control" id="flocation" name="flocation" placeholder="Specify Location" required="">
                            </div> 
                            ...
                            <div class="col-md-6">
                                ...
                                <option value="3">Lampu Jalan</option>  <!---Already added----->
                            </div>
